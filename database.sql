...
-- BCrypt Hash: $2a$10$gP.MlzKjQp4hNdfLq/yIquHw27891tH6G.VzS6T6Y0G3R0yvK2eDq (standard BCrypt hash for admin123)
INSERT INTO users (full_name, username, email, password_hash, phone, role, status) VALUES
('System Administrator', 'admin', 'admin@smartkyc.com', '$2a$10$gP.MlzKjQp4hNdfLq/yIquHw27891tH6G.VzS6T6Y0G3R0yvK2eDq', '+1234567890', 'Admin', 'Active');
